...
def load_data(messages_filepath, categories_filepath):
    ...
    Args:
        messages_filepath (str): messages filename
        categories_filepath (str): categories filename
...
def clean_data(df):
    '''
    The function takes a DataFrame with merged message/category columns
...
def main():
    '''
    Parse the command line arguments to process the data and save it in a database
    ...
    if len(sys.argv) == 4:
        ...
        'well as the filepath of the database to save the cleaned'\
        'data to as the third argument. \n\nExample: python'\
        'wrangle_data.py disaster_messages.csv'\
